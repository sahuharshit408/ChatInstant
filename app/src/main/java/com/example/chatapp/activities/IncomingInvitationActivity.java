...
public class IncomingInvitationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView textIncomingInvitationType = findViewById(R.id.textIncomingMeetingInvitation);
        meetingType = getIntent().getStringExtra(Constants.REMOTE_MSG_MEETING_TYPE);

        if (meetingType != null){
            if (meetingType.equals("video")){
                //imageMeetingType.setImageResource(R.drawable.ic_video_call);
                textIncomingInvitationType.setText(R.string.incoming_video_call);
            }else {
               // imageMeetingType.setImageResource(R.drawable.ic_phone_call);
                textIncomingInvitationType.setText(R.string.incoming_audio_call);
